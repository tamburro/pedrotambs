...
export const translations = {
  en: {
    ...
    resume: {
      ...
      title1: 'Senior Visual Designer',
      title2: 'Junior Visual Designer',
      title3: 'Visual Designer',
  ...
  pt: {
    ...
    resume: {
      ...
      title1: 'Designer Visual Pleno',
      title2: 'Designer Visual Junior',
      title3: 'Designer Visual PJ',
