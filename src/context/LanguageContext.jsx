  ...
  en: {
    ...
    services: {
      ...
      items: [
        ...
        { title: 'Product Design', description: 'User-centred interfaces crafted from research and validated through testing.' },
  ...
  pt: {
    ...
    services: {
      ...
      items: [
        ...
        { title: 'Product Design', description: 'Interfaces centradas no usuário, criadas a partir de pesquisa e validadas por testes.' },
