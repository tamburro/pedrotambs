...
export const projectsData = [
    {
        ...
        description_en: "AI-powered title and description generator for Mercado Livre and Shopee. Sellers paste the product name and technical specs — the app delivers a keyword-optimized title and a complete, publish-ready description in seconds.",
        year: "2026",
        ...
        sections: [
            ...
            },
            {
                ...
                content_en: "Demand for marketplace copywriting tools in Brazil is high and underserved. Generic tools like ChatGPT require sellers to craft prompts, interpret outputs, and adapt tone — a barrier for those unfamiliar with AI. Mercado Livre-specific solutions are scarce, and when they exist, they focus on pricing or inventory, not content. The ideal entry point: a 3-field flow (name, specs, platform) → result in under 10 seconds.",
                highlights: [
                ...
                highlights_en: [
                    ...
                    "Mercado Livre and Shopee have distinct rules and formats — a tool that understands this has a clear advantage"
                ],
                images: [
                    {
            ...
            },
            {
                ...
                highlights_en: [
                    "Platform generation — output adapted to each marketplace's rules",
                    "Configurable tone of voice — formal, technical, casual, or persuasive",
                    "Built-in SEO — high-volume keywords automatically embedded in the title",
                    "Smart regeneration — new result with one click, no need to rewrite data",
                    "Full history — all descriptions saved and accessible in the dashboard"
                ],
                images: [
                    {
            ...
            },
            {
                ...
                content_en: "The product was entirely built with AI coding — Claude as pair programmer at every stage, from scaffolding to deployment. Stack: Next.js 14 (App Router) on the frontend, API Routes for the backend, Prisma + PostgreSQL for data persistence and history, Claude API (claude-sonnet) for content generation, and Vercel for continuous deployment. The generation prompt was the most iterated artifact: each version was tested with real products across different categories — electronics, fashion, home — until output quality became consistent.",
                images: [
                    {
    ...
    },
    {
        ...
        description_en: "Visual system generator for founders, devs, and independent creators. Paste a seed color — Sigil generates a palette, design tokens, style guide, and exports everything to Tailwind, CSS vars, or Figma Variables. Cohesive visual identity without opening Figma.",
        year: "2026",
        role: "Product Designer & AI Engineer",
        timeline: "2 dias",
        team: "Solo",
        ...
        sections: [
            {
                ...
                content_en: "Founders, developers, and independent creators build products without a designer — and feel it in every inconsistent screen, off-pattern button, or improvised palette. Tools like Figma, Tokens Studio, and Brand.ai were built for designers. Solo builders don't have time to learn these workflows, nor the budget to outsource. The practical result: projects with fragmented visual identity, absent design tokens, and no way to scale the system without rework. The design system tooling market is large — but every solution assumes a designer in the loop."
            },
            {
                title: "Pesquisa de Mercado",
                title_en: "Market Research",
                ...
                highlights_en: [
                    ...
                    "Design tokens are known but rarely implemented by those without a designer",
            ...
            },
            {
                ...
                highlights_en: [
                    ...
                    "Brand Brief — living document: logo, colors, typography, tone of voice and usage examples",
            ...
            },
            {
                ...
                content_en: "The key learning was about the value of closing the loop. Palette tools are a dime a dozen — Sigil's differentiator is connecting seed color → tokens → code export in a single flow. The decision to include Component Preview was the most important one: seeing tokens working in real components, before exporting, dramatically reduced adoption friction. The 14-day unlimited trial model was chosen to ensure users reach the 'aha moment' — which only happens when they export and see the Tailwind config working in their own project."
            }
        ]
    },
    {
        ...
        sections: [
            ...
            },
            {
                ...
                content_en: "We moved from research findings to build the proto-persona and empathy map that guided all design decisions. The map revealed that Ana needs organization, not motivation — she already wants to avoid waste, she just lacks a tool that reduces planning friction. The main flow was defined prioritizing the lowest friction in item registration: camera to read fiscal receipts, pre-populated lists, and smart suggestions.",
                images: [
                    {
    ...
    },
    {
        ...
        sections: [
            ...
            },
            {
                ...
                content_en: "We developed two navigable prototypes. Model A: interactive moodboard — the user drags pieces that are suggested according to their choices. Model B: Tinder-style binary choice — like or discard looks, with new models suggested adaptively. 10 users tested the prototypes, 5 per model.",
                highlights: [
                ...
                highlights_en: [
                    "Model B was more intuitive — the swipe mechanism is already an established mental model",
                    "Large images (Model B) were more valued than miniature pieces (Model A)",
                    "The variety of categories — palettes, patterns, objects, not just clothing — gave users confidence that their style would be understood",
                    "Seeing a summary of all choices at the end was valued in both models",
                    "Model A users reported difficulty understanding how it worked — the learning curve was an obstacle"
                ],
                images: [
                    {
        ...
        sections: [
            ...
            },
            {
                ...
                highlights_en: [
                    ...
                    "Post-trip is completely ignored by apps — memories and photos get lost"
                ]
            },
            {
            ...
            },
            {
                ...
                content_en: "The project resulted in a cohesive solution with fluid navigation and collaboration as a central feature — not an addition. The key learning was about naming and architecture: using 'itinerary' and 'route' interchangeably caused confusion in the flow. The decision to simplify to just 'route' and 'trip' clarified the entire information hierarchy of the app."
            }
        ]
    },
    {
        ...
        title: "PixTudo",
        tagline: "Pesquisa sobre o uso do Pix por MEIs e autônomos.",
        tagline_en: "Research on how MEIs and freelancers use Pix.",
        year: "2025",
        role: "UX Researcher",
    },
    {
        ...
        category: "UX Research",
        title: "ZapVida",
        tagline: "Estudo sobre onboarding de planos de saúde via WhatsApp.",
        tagline_en: "Study on health plan onboarding through WhatsApp.",
        year: "2025",
        role: "UX Researcher",
    },
];
